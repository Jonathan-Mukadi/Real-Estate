    ...
    return (
        ...
        container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden'
            ...
            <p className='text-gray-500 max-w-80 text-center mb-8 '>
                About Properties, and Dedicated to Your Vision</p>
            <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
                ...
                <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                    ...
                    <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                        Earum laboriosam voluptatem ut sed ducimus. 
                        Consequatur voluptates alias numquam laboriosam distinctio quae blanditiis. 
                        Atque velit ipsum ex ut? Consectetur, rerum nobis!</p>
